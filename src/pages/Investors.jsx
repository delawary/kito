            ...
            <section className="section container">
                ...
                <div className="cta-section">
                    <Reveal width="100%">
                        ...
                        <a href="https://forms.gle/dYmusvaZoJcHghVb8" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'inline-block', textDecoration: 'none' }}>資料請求 / 事業相談</a>
                    </Reveal>
                </div>
            </section>
