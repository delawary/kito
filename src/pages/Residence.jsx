            ...
            <section className="section container">
                ...
                <div className="cta-section">
                    <Reveal width="100%">
                        ...
                        <a href="https://forms.gle/dYmusvaZoJcHghVb8" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'inline-block', textDecoration: 'none' }}>住まいについて相談する</a>
                    </Reveal>
                </div>
            </section>
