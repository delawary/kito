    ...
    return (
        <div className="page-container">
            <header className="page-header">
                <div className="header-image" style={{ backgroundImage: `url(${guestRoom})` }}></div>
                <div className="header-overlay"></div>
                <div className="container header-content">
                    <h1 className="page-title fade-in-up">The Stay</h1>
                    <p className="page-subtitle fade-in-up delay-1">心身ともに、深呼吸する場所</p>
                </div>
            </header>

            <section className="section container">
                <div className="concept-text text-center fade-in-up delay-2">
                    <p>
                        五感で感じる木の香り。<br />
                        静寂に包まれたプライベートな空間。<br />
                        窓の外に広がる、ありのままの自然。
                ...
                <div className="gallery-grid fade-in-up">
                    <div className="gallery-item large" style={{ backgroundImage: `url(${guestRoom})` }}>
                        <div className="caption">Private Cabin</div>
                    </div>
                    {/* Placeholders for more images later */}
